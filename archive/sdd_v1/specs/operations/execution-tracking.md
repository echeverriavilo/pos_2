...
- Durante el análisis y la definición de scope, el orchestrator debe revisar `specs/architecture/system-overview.md`, `specs/architecture/multitenancy.md`, `specs/product/vision.md`, `specs/product/roles.md` y `specs/glossary.md` para contextualizar el dominio antes de modificar cualquier código.
